...
async def start(rest_args=None):
    ...
    parser.add_argument(
        "-b",
        "--source",
        help="""anubis, baidu, bing, binaryedge, bingapi, bufferoverun, censys, certspotter, crtsh,
            ...
            for engineitem in engines:
                if engineitem == "anubis":
                    ...
                    try:
                        ...
                        stor_lst.append(
                            store(n45ht_search, engineitem, store_host=True)
                        )
                    except Exception as e:
                        print(e)
                    ...
                    try:
                        ...
                        stor_lst.append(
                            store(omnisint_search, engineitem, store_host=True)
                        )
                    except Exception as e:
                        print(e)
                    ...
                    try:
                        ...
                        stor_lst.append(
                            store(
                                spyse_search, engineitem, store_host=True, store_ip=True
                            )
                        )
                    except Exception as e:
                        print(e)
