...
# cisagov Libraries
from api.db_manager import ReportManager

db_manager = ReportManager()


def create_report(body=None):  # noqa: E501
    """Add a new report to the data store.

     # noqa: E501

    :param body: Report object to be added to data store
...
def delete_report_by_uuid(uuid):  # noqa: E501
    """Delete a Report.
...
def get_all_reports(filter_params=None):  # noqa: E501
    """Find all Reports.
...
def get_report_by_uuid(uuid):  # noqa: E501
    """Find template by uuid.

    Returns a single Report # noqa: E501
...
def update_report_by_uuid(uuid, body=None):  # noqa: E501
    """Update an existing Report.

     # noqa: E501

    :param uuid: uuid of Report to update
    :type uuid: str
    :param body: Report object to be added to data store
    :type body: dict | bytes
